...
class player(QObject):
    ...
    def myplay(self):
        ...
        self.toplrc.tableWidget.item(0, 1).setIcon(QtGui.QIcon('resource/pause1.png'))
    ...
    def stop(self):
        ...
        self.toplrc.tableWidget.item(0, 1).setIcon(QtGui.QIcon('resource/play1.png'))
...
class Ui_Widget(QWidget):
    ...
    def ini(self):
        ...
        for x in l:
            if 'resource/ffmpeg.exe' in x:
                gm.st.set_confi('path_section', 'jmexe', x)
                continue
            a = fs.os.system("%s -h" % x)
            if a == 0:
                gm.st.set_confi('path_section', 'jmexe', x)
                if fs.delete_file('resource/ffmpeg.exe'):
